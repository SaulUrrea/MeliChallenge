...
class ItemMock {
    fun getItemMockSample(): ItemModel {
        return ItemModel(
            ...
            attributeModels = listOf(
                ...
                AttributeModel(
                    attributeGroupId = "GROUP_ID_2",
                    attributeGroupName = "GROUP_NAME_2",
                    id = "ATTRIBUTE_ID_2",
                    name = "Attribute Name 2",
                    source = 67890L,
                    valueId = "VALUE_ID_2",
                    valueName = "Value Name 2",
                    valueType = "number"
                ),
                AttributeModel(
                    attributeGroupId = "GROUP_ID_2",
            ...
            price = 1000.0,
            sellerModel = SellerModel(id = 12345, nickname = "Test Seller"),
            sellerContactModel = SellerContactModel(
                areaCode = "123",
                areaCode2 = "456",
